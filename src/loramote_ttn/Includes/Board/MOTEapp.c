...
typedef enum {moteStartup, moteReset, moteSetDevaddr, moteSetAppskey, moteSetNwkskey, moteSetAdr, moteSetRx2, moteSetSync, moteSetChStatus, moteJoinAbp, moteWaitAccepted, moteIniTx, moteWaitIniTxOk, moteRest, moteTxUncnf, moteTxWait, moteDone, moteComFailure} MOTE_T;
